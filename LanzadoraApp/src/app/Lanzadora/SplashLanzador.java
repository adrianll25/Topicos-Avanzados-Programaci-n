...
import app.Conversiones.Splash;
 ...
 * @author adria
 */
public class SplashLanzador extends javax.swing.JFrame implements ActionListener{

    Timer timer;
    
    public SplashLanzador() {
      ...
      public static void ejecutar () {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SplashLanzador().setVisible(true);
            }
        });
    }
    ...
    private void initComponents() {
        ...
        jLabLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Tec.jpg"))); // NOI18N
