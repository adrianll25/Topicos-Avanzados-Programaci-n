 ...
 * @author adria
 */
public class SplashMiHiloApp extends javax.swing.JFrame implements ActionListener{

    Timer timer;
    
    public SplashMiHiloApp() {
  ...
  public static void ejecutar () {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SplashMiHiloApp().setVisible(true);
            }
        });
    }
    ...
    private void initComponents() {
        ...
        jLabLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/CarrerasApp.jpg"))); // NOI18N
