 ...
 * @author adria
 */
public class SplashFrameBeans extends javax.swing.JFrame implements ActionListener{

    Timer timer;
    
    public SplashFrameBeans() {
  ...
  public static void ejecutar () {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SplashFrameBeans().setVisible(true);
            }
        });
    }
    ...
    private void initComponents() {
        ...
        jLabLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/Prisma_Splash.jpg"))); // NOI18N
