 ...
 * @author adria
 */
public class SplashPelotasRebotando extends javax.swing.JFrame implements ActionListener{

    Timer timer;
    
    public SplashPelotasRebotando() {
  ...
  public static void ejecutar () {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SplashPelotasRebotando().setVisible(true);
            }
        });
    }
    ...
    private void initComponents() {
        ...
        jLabLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/PelotasApp.jpg"))); // NOI18N
        ...
        jLabel3.setText("MiHiloApp v1.0");
